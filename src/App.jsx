  ...
  return (
    <section className="max-w-7xl mx-auto px-6 lg:px-10 py-16 lg:py-24 grid lg:grid-cols-[0.9fr_1.1fr] gap-16">
      <div>
        ...
        <div className="mt-6 flex items-center gap-4 p-5 rounded-sm border" style={{ borderColor: "rgba(31,58,46,0.12)", background: "white" }}>
          <img src={TOMAS_PHOTO} alt="Tomas Echeverria" className="w-20 h-20 rounded-full object-cover shrink-0" />
          <div>
        ...
        <div className="mt-4 flex items-center gap-4 p-5 rounded-sm border" style={{ borderColor: "rgba(31,58,46,0.12)", background: "white" }}>
          <img src={MARIA_PHOTO} alt="Maria Saad" className="w-20 h-20 rounded-full object-cover shrink-0" />
          <div>
